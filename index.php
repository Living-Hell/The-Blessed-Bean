...
<head>
    ...
    <title>The Blessed Bean - Home</title>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12 text-center">
                    ...
                    <h1 class="brand-name">The Blessed Bean</h1>
                    <hr class="tagline-divider">
                    <h2>
                        <small>By
                            <strong>Shushant Kumar</strong>
                        </small>
                    </h2>
                </div>
            </div>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <hr class="visible-xs">
                    <p>Making the perfect cup of coffee can be challenging! With so many unique flavours and recipes to chose from,
                        where do you begin? Our website provides you with the best recipes from around the world. Whether you prefer
